...
High performance Node.js (with native C addons) mining pool for Dosh.
...
git clone https://github.com/realready/dosh-pool dosh_pool
...
"poolServer": {
    ...
    "poolAddress": "XwnmG9j8tZ6eeztCRYd5LpLDnF9ktiamwCZzgk7apXDRYnwB9hFJSahAFktnAwSKUTERZN5pHTTjR8eGjGGqyDRQ1aiFMypda"
...
/* Module that sends payments to miners according to their submitted shares. Careful of "Mixin too big" error*/
"payments": {
    "enabled": true,
    "interval": 86400, //how often to run in seconds. 86400 = 24 hours
...
var cryptonatorWidget = ["DOSH-BTC", "DOSH-USD", "DOSH-EUR"];
...
```bash
curl 127.0.0.1:<port-here>/json_rpc -d '{"method":"getblockheaderbyheight","params":{"height":100}}'
```
